    ...
    .bind('init', function(evt, map) {
        ...
        $(map).click( function(event) {
            ...
            $('#map_canvas').gmap('addMarker', {
                ...
                $('#markerdiv').append('<div class="mclass' + markerId + '" style="display:none; width:50px">'                               
                  + '<div data-role="fieldcontain" style="width:50px"><label for="tag' + markerId + '">Marker Title<br/></label><input type="text" size="14" maxlength="30" name="tag' + markerId + '" id="tag' + markerId + '" value="" style="width:120px" /></div>'
                  + '<div data-role="fieldcontain"><label for="address' + markerId + '">Address<br/></label><input type="text" size="14" maxlength="30" name="address' + markerId + '" id="address' + markerId + '" value="" style="width:120px"/></div>'
                  + '<div data-role="fieldcontain"><label for="state' + markerId + '">City, State<br/></label><input type="text" size="14" maxlength="30" name="state' + markerId + '" id="state' + markerId + '" value="" style="width:120px"/></div>'
                  + '<div data-role="fieldcontain"><label for="comment' + markerId + '">Comment<br/></label><textarea maxlength="64" cols=14 rows=3 name="comment' + markerId + '" id="comment' + markerId + '" value="" style="width:120px"/></textarea></div>'                              
                  + '</div>');
                getGeoData(marker);
				}).dragend( function() {
	                 getGeoData(this);
                ...
                if (status === "OK") {
                    ...
                    $('#map_canvas').gmap('addMarker', {
                        ...
                        $('#markerdiv').append('<div class="mclass' + markerId + '" style="display:none;">'                               
                          + '<div data-role="fieldcontain"><label for="tag' + markerId + '" style="font-size:15px">Marker Title<br/></label><input type="text" size="24" maxlength="30" name="tag' + markerId + '" id="tag' + markerId + '" value="" /></div>'
                          + '<div data-role="fieldcontain"><label for="address' + markerId + '" style="font-size:15px">Address<br/></label><input type="text" size="13" maxlength="20" name="address' + markerId + '" id="address' + markerId + '" value="" /></div>'
                          + '<div data-role="fieldcontain"><label for="state' + markerId + '" style="font-size:15px">City, State<br/></label><input type="text" size="13" maxlength="20" name="state' + markerId + '" id="state' + markerId + '" value="" /></div>'
                          + '<div data-role="fieldcontain"><label for="comment' + markerId + '" style="font-size:15px">Comment<br/></label><textarea maxlength="64" cols=24 rows=3 name="comment' + markerId + '" id="comment' + markerId + '" value="" /></textarea></div>'                              
                          + '</div>');
                        getGeoData(marker);
        				}).dragend( function() {
        	                 getGeoData(this);
